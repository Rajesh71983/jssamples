	...
	<body>
        ...
        <tbody>
            <tr>
                <td>Tiger</td>
                <td>Nixon</td>
                <td>System Architectasdasdasda</td>
                <td>Edinburghasdasdas</td>
                <td>61</td>
                <td>2011/04/25</td>
                <td>$320,800</td>
                <td>5421</td>
                <td>t.nixon@datatablesasdasdas.net</td>
            </tr>
            <tr>
                <td>Garrett</td>
                <td>Winters</td>
            ...
            <tr>
                <td>Ashton</td>
                <td>Cox</td>
                <td>Junior Technical Authorasdasdasdasdas</td>
                <td>San Franciscoasdasdasdasd</td>
                <td>66</td>
                <td>2009/01/12</td>
                <td>$86,000</td>
                <td>1562</td>
                <td>a.cox@datatablesadasdasdasdasdasdaasdasdasds.net</td>
            </tr>
            <tr>
                <td>Cedric</td>
                <td>Kelly</td>
	...
	<script>
		$(document).ready(function() {
			$('#example').DataTable( {
				...
				//"data": "column_name", //this name should exist in your JSON response
				"render": function ( data, type, full, meta ) {
				  return '<span class="label label-danger lastname" >'+data+' hello</span>';
				}
			  } ]
			});
			...
			$("#example").on("click",".lastname",function(){
				alert($(this).html());
			});
		});
	</script>
